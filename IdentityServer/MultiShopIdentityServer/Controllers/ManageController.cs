...
using MultiShopIdentityServer.Models.ManageViewModels;
using MultiShopIdentityServer.Models;
using MultiShopIdentityServer.Services;
using Microsoft.Extensions.Localization;
using MultiShopIdentityServer.Resources;
...
public class ManageController : Controller
{
    ...
    public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
    {
        ...
        await _emailSender.SendEmail(
            model.Email,
            "MultiShopIdentityServer Verification Email",
    ...
    private string GenerateQrCodeUri(string email, string unformattedKey)
    {
        return string.Format(
            ...
            _urlEncoder.Encode("MultiShopIdentityServer"),
