...
using MultiShop.IdentityServer.Models.ManageViewModels;
using MultiShop.IdentityServer.Models;
using MultiShop.IdentityServer.Services;
using Microsoft.Extensions.Localization;
using MultiShop.IdentityServer.Resources;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            await _emailSender.SendEmail(
               model.Email,
               "MultiShop.IdentityServer Verification Email",
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MultiShop.IdentityServer"),
